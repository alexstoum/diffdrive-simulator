...
def circle_waypoints(radius: float, num_points: int = 200, center=(0.0, 0.0)) -> List[Tuple[float,
 float]]:
...
def line_waypoints(start: Tuple[float, float], end: Tuple[float, float],
...
def figure8_waypoints(a: float = 2.0, b: float = 1.0, num_points: int = 400) -> List[Tuple[float,
 float]]:
